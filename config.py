...
if 'Kali' in release:
    ...
    packages_to_install = ['most', 'ttf-mscorefonts-installer', 'pydf', 'htop', 'gobuster', 'amass',
                           ...
                           'exe2hexbat', 'shellter', 'grc', 'flameshot', 'stow', 'xclip', 'ssh-askpass', 'docker', 'docker.io', 'docker-registry','software-properties-common']

    # These kali packages will be removed
    packages_to_remove = []

    # These python packages will be installed globally
    pip_packages = ['pipenv', 'pylint', 'dnsgen', 'stegcracker', 'truffleHog', 'apkleaks', 'updog']
    ...
    personal_repositories_to_sync = [
                                    'git@github.com:rudem323/dotfiles',
                                    'git@github.com:rudem323/mykali'
                                    ]
